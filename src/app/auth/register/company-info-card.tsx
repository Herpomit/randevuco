                ...
                <div className=" ">
                  ...
                  <div className="text-center text-xs text-gray-400">
                    <p className="mt-1">
                      ...
                      >Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis asperiores vitae ipsam deleniti ducimus amet ullam ipsum recusandae voluptatem aperiam culpa id doloribus, quae corporis maiores veniam quam. Natus, eius.</ModalContainer>

                      {" "}ve{" "}{" "}
                      <a href="#" className="text-primary hover:underline">
                        <ModalContainer button="Gizlilik Politikası" triggerClass="text-black" contentClass="max-w-xs md:max-w-3xl lg:max-w-5xl" title="Gizlilik Politikası">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi quia debitis earum quos perspiciatis repudiandae necessitatibus unde accusamus in nihil, repellendus voluptates odio consequatur, quis esse aliquam, iure neque. Minima.</ModalContainer>
                      </a>
